...
class RegisterMachineTranslationEngines implements ServiceProviderInterface
{
    ...
    public function add_engine( $engines ){
        $engines[] = [ 
            ...
            'label' => esc_html(__('DeepSeek', 'deepseek-ai-translate-for-translatepress')), // translators: translation engine name
        ];
        ...
        <tr>
            <th scope="row">
                <?php 
                    ...
                    echo esc_html(__('deepseek api key', 'deepseek-ai-translate-for-translatepress'));
                ?>
            </th>
            <td>
                <?php
                ...
                <p class="description">
                    <?php 
                        ...
                        echo esc_html(__('key format: app id#app secret#VOCABID(optional)', 'deepseek-ai-translate-for-translatepress'));
                    ?>
                </p>
                <p class="description">
                    <?php 
                        // translators: visit deepseek api url.
                        $text = __( 'Visit <a href="%s" target="_blank">this link</a> to see how you can set up an API key and control API costs.', 'deepseek-ai-translate-for-translatepress' );
